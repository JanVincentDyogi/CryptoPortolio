  ...
  return (
    <Router>
      ...
      <Routes>
        <Route
          path="/"
          element={<Home cryptoAssets={cryptoAssets} totalValue={totalValue} />}
        />
        <Route
          path="/market"
          element={
        ...
        <Route
          path="/watchlist"
          element={<Watchlist cryptoData={cryptoData} favorites={favorites} />}
        />
        <Route
          path="/crypto/:cryptoId"
          element={<CryptoDetails cryptoData={cryptoData} />}
        />
        <Route
          path="/buysell"
          element={
